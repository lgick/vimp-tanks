...
export default {
  ...
  coreParams: {
    ...
    // slickTime — остаток, с: после съезда гусеницы ещё столько скользят,
    // эффект спадает линейно. Только у масла: песок и грязь с гусениц не
    // тянутся, без поля остатка нет
    surfaces: {
