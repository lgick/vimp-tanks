...
export default {
  ...
  coreParams: {
    ...
    levels: {
      ...
      fallDamage: 15, // урон за ОДИН уровень высоты (0 — падение бесплатно)
      ...
      // скорости на уклоне уходит в полёт
      rampLaunchFactor: 1.0,
      ...
      landingShake: {
        intensity: 6, // при полном ударе, единицы как у оружия
        duration: 300, // мс
