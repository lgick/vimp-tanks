...
export default {
  ...
  // мостовые ящики — по одному тайлу и стоят в разрывах перил (плита там
  // тоже проезжая): три средних ряда плиты остаются свободными, по ним
  // идут отладочные сценарии
  physicsDynamic: [
    box(20, 28, 0),
    box(60, 28, 0),
    box(ledgeNorth.x0, bridge.railNorth, 1, 32),
    box(ledgeSouth.x1, bridge.railSouth, 1, 32),
  ],
