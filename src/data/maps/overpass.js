...
export default {
  ...
  // Мостовые ящики — по одному тайлу и стоят на крайних рядах плиты ВДАЛИ
  // от разрывов перил: у динамики карты нет правил уровня (падать она не
  // умеет), поэтому вытолкнутый в разрыв ящик уехал бы за край плиты и
  // повис над землёй. Средний ряд плиты (29) свободен — по нему идут
  // отладочные сценарии
  physicsDynamic: [
    box(20, 28, 0),
    box(60, 28, 0),
    box(24, bridge.slabTop, 1, 32),
    box(64, bridge.slabBottom, 1, 32),
  ],
