...
// эстакада (уровень 1) шириной в 5 тайлов проезжей плиты, с двумя
// рампами, перилами и двумя разрывами перил.
...
export default {
  ...
  // Ряд 29 плиты свободен — по нему идут отладочные сценарии
  physicsDynamic: [
    box(20, 28, 0),
    box(60, 28, 0),
