export default {
  ...
  w1: {
    type: 'hitscan',
    // сила импульса (кг*м/с); больше не масштабируется дальностью выстрела
    // в ядре (TanksSim::process_hitscan) — значение выбрано равным старому
    // эффективному импульсу (impulseMagnitude·range = 5000·1500)
