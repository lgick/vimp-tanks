...
| 9 | Наклон корпуса на рампе: оси тангажа/крена и подъём края | 9 | ⬜ |
...
## Этап 9. Наклон корпуса на рампе (проблема 9)
...
Ручной прогон `npm run dev` на `downtown` по всем пунктам (1–11) о тестировании, за обе команды, с ресайзом
